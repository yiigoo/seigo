    ...
    <div className="page-container">
      ...
      <div className={styles.content}>
        <p>
          ...
          are located in Shenzhen, with convenient transportation access. Our
          main products include earphones, headphones, Bluetooth related
          products, wireless chargers and other smart phone accessories, All of
          our products comply with international quality standards and are
        ...
        <p>
          ...
          have gained a good reputation ,we sincerely looking forward to
